...
public class word_ladder {
    ...
    private void readAndBuildGraph(String filename) {
        String path = "src/main/java/Project2_6513172/";
        words = new ArrayList<>();
...
//        menu();
    ...
    public void findWordLadder(String startWord, String endWord) {
        try {
            ...
            GraphPath<String, DefaultWeightedEdge> path = dijkstra.getPath(startWord, endWord); //เก็บเส้นทางไว้ใน GraphPath
    ...
    public void searchNeighbor(){
        ...
        while (true) {
            ...
            word_nei = scan1.nextLine().toLowerCase();
            System.out.println();
    ...
    public void showNeighbors(String word_nei) {
        ...
        for (String otherWord : words) {
            if(!word_nei.equalsIgnoreCase(otherWord)){
